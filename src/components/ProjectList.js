        ...
        <Row>
          <Col className="projectCard" xs="12" sm={{ size: "5", offset: 1 }}>
            <Card style={{ maxWidth: "250px", margin: "auto" }}>
              <h4 className="projectTitle">Flatiron Field Day</h4>
              ...
              <img
                ...
                id="Flatiron Field Day"
                className="projectImage"
                src="https://s3.amazonaws.com/dickwardportfolio/Field+Day+Timelapse+Mini.gif"
                alt="Flatiron Field Day Time Lapse"
              />
